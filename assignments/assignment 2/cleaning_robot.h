...
const int MAX_PATH = MAP_WIDTH * MAP_HEIGHT;
...
//          it returns the constant MAX_PATH and that indicates that the specified position is unreachable.
// Parameters:
// 	robot_x: the x coordinate of the robot
// 	robot_y: the y coordinate of the robot
...
// 	if the target cannot be reached, the constant MAX_PATH is returned  
...
//      If the robot cannot go there within the robot_energy,
//          it returns the constant MAX_PATH and that indicates that that position is unreachable.
// Parameters:
// 	robot_x: the x coordinate of the robot
// 	robot_y: the y coordinate of the robot
// 	target_x: the x coordinate of the target
